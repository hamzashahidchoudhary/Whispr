...
export default function Login() {
    ...
    return (
        <div className="min-h-screen min-h-dvh flex flex-col bg-[#0f1117]">
            {/* Top gradient banner - visible on all sizes */}
            ...
            <div className="flex flex-1">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-8">
                    <div className="w-full max-w-sm">
                        ...
                        <h1 className="text-2xl font-bold text-white mb-1 text-center lg:text-left">Welcome back</h1>
                        <p className="text-gray-400 mb-6 text-sm text-center lg:text-left">Sign in to continue to Whispr</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#1a1d27] border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-600 transition-all text-base"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-[#1a1d27] border border-gray-700 text-white rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-600 transition-all text-base"
                                        placeholder="••••••••"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3.5 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 active:scale-[0.98] disabled:opacity-50 transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/25 text-base mt-2"
                            >
